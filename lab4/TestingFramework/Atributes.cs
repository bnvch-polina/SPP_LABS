...
public class Atributes
{
    ...
    public class TestCaseSourceAttribute(string sourceMemberName) : Attribute
    {
        public string SourceMemberName { get; } = sourceMemberName;
    }

    // Доп. метаданные для фильтрации тестов.
    ...
    public class TestMetaAttribute : Attribute
    {
        ...
        public TestMetaAttribute(string? category = null, int priority = 0, string? author = null)
        {
            Category = category;
            Priority = priority;
            Author = author;
